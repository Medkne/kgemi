...
def main():
    train = read("datasets/original_without/train.txt")
    valid = read("datasets/original_without/valid.txt")
    test = read("datasets/original_without/test.txt")
    model_path = "models/MKG/final_original.chkpnt"
